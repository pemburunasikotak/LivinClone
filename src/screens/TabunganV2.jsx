...
const TabunganNowScreen = () => {
  ...
  const dataHasil = [
    {
      ...
      data: [
        ...
        },
        {
          ...
          status: 'out',
          keterangan: 'Biaya',
          detaiKeterangan: 'Biaya Transfer',
        },
      ],
    },
    {
  ...
  const dataTransaksi = cek
    ? dataBulanBerjalan
    : dataHasil.find(item => item.bulan == menuItems[activeIndex]) ||
      dataKosong;

  // console.log('CEK DISINI', dataTransaksi)
  // const dataMutasi = typeof(mutasi) === "string" ? JSON.parse(mutasi) : mutasi
  // console.log('CEK MASUK', dataMutasi, typeof(dataMutasi))
