        ...
        <View
          ...
          <View style={{display: 'flex', flexDirection: 'row', padding: 15}}>
            ...
            <TouchableOpacity
              ...
              <Text style={{color: '#005EB1', fontWeight: '300', fontSize: 14}}>
                E-Statement
              </Text>
            </TouchableOpacity>
          </View>
          <View style={{display: 'flex', flexDirection: 'row'}}>
            <View style={{width: '89%', paddingLeft: 20}}>
              <ScrollView
                ref={scrollViewRef}
                horizontal
                ...
                {menuItems.map((item, index) => (
                  <TouchableOpacity
                    ...
                    style={{
                      ...
                      paddingRight: index === menuItems.length - 1 ? 100 : 12,
                    }}>
                    <Text
                      style={{
                        fontSize: 16,
                        color: activeIndex === index ? '#005EB1' : 'black',
                      }}>
                      {item}
                    </Text>
                    <View
                      style={{
                        ...
                        width: '100%',
                        backgroundColor:
                          activeIndex === index ? '#005EB1' : 'transparent',
                        marginTop: 5,
                      }}
                    />
                  </TouchableOpacity>
          ...
          <ScrollView>
            {dataTransaksi.data.length > 0 ? (
                  ...
                  {index == dataTransaksi.data.length - 1 && (
                    <View style={{marginVertical: 50}}>
                      <Text style={{textAlign: 'center'}}>
                        Anda telah mencapai ahir mutasi transaksi bulan ini
                      </Text>
                    </View>
                  )}
                </View>
              ...
              <View
                ...
                <Text style={{}}>Belum ada transaksi pada bulan ini.</Text>
              </View>
            )}
          </ScrollView>
        </View>
